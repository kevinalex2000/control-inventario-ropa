...
if (!isset($_SESSION['nombre'])) {
  ...
  if ($_SESSION['escritorio'] == 1) {
    ...
    $ventas30dias = $consulta->ventasultimos_30dias();
    $fechasv30 = '';
    $totalesv30 = '';
    while ($regfecha = $ventas30dias->fetch_object()) {
      $fechasv30 = $fechasv30 . '"' . $regfecha->fecha . '",';
      $totalesv30 = $totalesv30 . $regfecha->total . ',';
    }

    //quitamos la ultima coma
    $fechasv30 = substr($fechasv30, 0, -1);
    $totalesv30 = substr($totalesv30, 0, -1);
